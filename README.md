...
```sh
npm install git+ssh://git@github.com:cellect-ai/cellect-sdk-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/cellect-ai/cellect-sdk-typescript/issues) with questions, bugs, or suggestions.
